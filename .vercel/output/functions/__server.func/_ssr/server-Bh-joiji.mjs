...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-Difzl250.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CmTV78fr.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DRdiPy_M.mjs"),
		import("./start-D8JSpygS.mjs"),
